 ...
 * @author Junior RT
 * @version 1.0
 * @license Get Arrays, LLC (<a href="https://www.getarrays.io">Get Arrays,
 *          LLC</a>)
...
public class ContactResource {
    ...
    public ResponseEntity<Contact> createContact(@RequestBody Contact contact) {
        ...
        return ResponseEntity.created(URI.create("/api/contacts/userID")).body(contactService.createContact(contact));
    }
